...
const PVP_ENEMIES = [
  ...
  {name:'Golem',    spr:'🗿', hp:46, atk:5,  pat:['def','atk','atk'], armor:6, desc:'เกราะหนา (ลดดาเมจ)'},
  {name:'Wraith',   spr:'👻', hp:34, atk:7,  pat:['atk','def','atk']},
  {name:'Troll',    spr:'🧌', hp:42, atk:6,  pat:['atk','atk','heal'], regen:5, desc:'ฟื้นเลือดตัวเอง'},
  {name:'Cactus',   spr:'🌵', hp:36, atk:4,  pat:['def','atk','def'], thorns:3, desc:'หนาม (ตีโดนเจ็บเอง)'},
  {name:'Assassin', spr:'🥷', hp:20, atk:12, pat:['atk','atk','atk'], desc:'ตีแรงมาก HP น้อย'},
  {name:'Mimic',    spr:'🎁', hp:38, atk:7,  pat:['def','atk','rage'], desc:'ยิ่งโดนตียิ่งโกรธ'},
  {name:'Shaman',   spr:'🧙', hp:32, atk:6,  pat:['heal','atk','def'], regen:4, desc:'หมอผีฟื้นเลือด'},
];
// บอสชั้น 20
const PVP_BOSS = {name:'Tower Lord',spr:'👹', hp:120, atk:10, pat:['atk','def','rage','atk'], armor:3, desc:'เจ้าหอคอย — บอสสุดท้าย'};
